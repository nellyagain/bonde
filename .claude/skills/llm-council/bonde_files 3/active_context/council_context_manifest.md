...
- `council_queue_2026-05-23.csv` — LOADED
- `daily_decision_log_2026-05-23.csv` — LOADED
...
- `active_burst_gate6_observational_watchlist_2026-05-24.md` — LOADED
...
- `council_resolver_report_2026-05-24.md` — LOADED
- `daily_learning_report_2026-05-24.md` — LOADED
...
- `hypothesis_tracker_2026-05-24.md` — LOADED
...
- `learning_loop_executive_digest_2026-05-24.md` — LOADED
...
- `weekly_learning_report_2026-W21.md` — LOADED

## Current council candidate set

AOSL, EXTR, FROG, UTI, ZM
