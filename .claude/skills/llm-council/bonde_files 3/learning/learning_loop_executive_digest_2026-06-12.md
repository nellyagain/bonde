...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **877**; rows ≥5 future bars: **2,035**; unique full-plan+price ticker-date rows: **451**. (§13)
...
4. **Track KK confirmation.** H_KK_CONFIRMATION is alive, low sample (n=114), measurement-only; do not hard-gate Bonde rows from KK yet. (§9)
...
## 2. Changed since last run — 2026-06-11 08:05 UTC → 2026-06-12 15:28 UTC
- Prior digest date: **2026-06-11**
- Current digest date: **2026-06-12**
- Comparison window: **2026-06-11 → 2026-06-12**

### Current pipeline status
- SLINGSHOT decision-log target/R:R backfilled rows: **586**.
- Tiny-geometry hygiene flagged rows: **34**.
...
- KK confirmation: alive, sample n=114, measurement-only.
...
### Deltas vs prior run
- SLINGSHOT OK_EVALUABLE rows: **877** (prior 675, Δ +202).
- SLINGSHOT rows ≥5 future bars: **2,035** (prior 1,734, Δ +301).
- Post-V5.9.19 TRADE rows: **10** (prior 10, Δ +0).
- A1 rows: **0** (prior 0, Δ +0).
- A2 rows: **17** (prior 17, Δ +0).
- TRADE row identity: unchanged (n=10).
- Rule-readiness READY/SUPPORTED ids: **2** (prior 1); added: H_MB_EXIT_DAY3_FILTER.
- Rule-readiness CANDIDATE ids: **1** (prior 2); removed: H_MB_EXIT_DAY3_FILTER.
...
1. Sugar Baby=True candidates show 0.23% avg T+5 versus -0.45% for non-Sugar Baby candidates (evaluated n=4622 vs 2946). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| SLINGSHOT      |      590 |              454 | ACTIONABLE_SAMPLE |         93.2203 |            57.554  |         0.648042  |
| ACTIVE_BURST   |      215 |              184 | ACTIONABLE_SAMPLE |         93.4884 |            40      |        -0.911939  |
| PAUSE          |      199 |              156 | ACTIONABLE_SAMPLE |         83.4171 |            57.0312 |         1.01639   |
| EP_ACTIVE      |       96 |               86 | ACTIONABLE_SAMPLE |         85.4167 |            47.2222 |         0.395695  |
...
| EP_ACTIVE      | WATCH_ONLY      | B              | WATCH                |       38 |               33 | ACTIONABLE_SAMPLE |            55.1724 |          3.67813  |
...
| SLINGSHOT      | WATCH_ONLY      | B              | WATCH                |      283 |              230 | ACTIONABLE_SAMPLE |            69.863  |          1.41204  |
| PAUSE          | WATCH_ONLY      | B              | WATCH                |      147 |              110 | ACTIONABLE_SAMPLE |            56.5217 |          0.98975  |
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       76 |               54 | ACTIONABLE_SAMPLE |            45.098  |          0.943255 |
...
|:---------------|:---------------|:----------------|:----------------|:---------------|:--------------|:---------------|:---------------|:--------------|:-----------------------------|:----------------------|:-------------|:--------------------------------------------------|
| ~~PAUSE~~      | ~~B~~          | ~~110~~         | ~~0.9897~~      | ~~56.52~~      | ~~C~~         | ~~42~~         | ~~1.565~~      | ~~59.38~~     | ~~+0.58~~                    | ~~H_PAUSE_BC_INVERT~~ | ~~-2.79~~    | ~~CLOSED (diagnostic: REJECTED / NOT_CONFIRMED)~~ |
...
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Risk-On          |            42 |         1.56497 |           110 |        0.98975  |              0.575223 | 2026-05-16       |        16 |        74 |          -2.78813 | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Risk-On          |             3 |         2.29367 |           111 |        0.378915 |              1.91476  | 2026-05-17       |         2 |        69 |           2.06184 | WATCHING_LOW_SAMPLE        |
...
### KK summary (v4.14.06)
- KK confirmation: alive, low sample (n=114), measurement-only.
...
|:------------------|:--------------------|:---------------------|-----------------:|-------------------:|----------------------------:|-----------------------------------------:|--------------------------:|------------------------------------:|-------------------------:|---------------------------------:|-----------------------------------:|
| H_KK_CONFIRMATION | WATCHING_LOW_SAMPLE | True                 |                3 |                111 |                     1.91476 |                                      0.5 |                       nan |                                  80 |                      100 |                          10.9967 |                                  0 |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      135 |              111 |         0.415806 |              0.378915 |                81 |          1.32115  |                30 |          0.191018 |
| BONDE_ANTICIPATION_WITH_KK_CONFIRMATION    |        3 |                3 |         0.902316 |              2.29367  |                 2 |          0.382975 |                 0 |        nan        |

**Strict OOS cohort split (signal_date >= 2026-05-17; drives verdict):**
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |       91 |               69 |         0.632869 |               1.19422 |                41 |          1.62347  |                 0 |               nan |
| BONDE_ANTICIPATION_WITH_KK_CONFIRMATION    |        2 |                2 |         0.731373 |               3.25606 |                 1 |          0.143854 |                 0 |               nan |

**KK classification audit sample:**
_Row table suppressed until n>=10/slice; current confirmed n=2, distinct flag patterns=37._
...
- Rows: **2,597**; full-plan proxy rows: **1,324**; rows with ≥5 future bars: **2,035**; OK-evaluable rows: **877**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **586**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=2,413** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=6 (excluded).
- Latest pack health: `2026-06-11` **211/211** rows CAPTURED_AT_TRIGGER (entry capture healthy).
- Top missing/evaluability reasons:
| primary_missing_reason   |   rows |
|:-------------------------|-------:|
| NO_PRICE_DATA            |   1090 |
| OK_EVALUABLE             |    877 |
| INSUFFICIENT_FUTURE_BARS |    263 |
| MISSING_ENTRY            |    184 |
| NEVER_TRIGGERED          |    108 |
...
- Current read: Sugar Baby=True candidates show 0.23% avg T+5 versus -0.45% for non-Sugar Baby candidates (evaluated n=4622 vs 2946).
...
- Sugar Babies ticker lookup rows: **494**
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     5447 |                4622 |             0.225314 |               47.1874 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     4778 |                4068 |             0.548914 |               48.0826 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     3565 |                2946 |            -0.454272 |               50.3055 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     3101 |                2582 |            -0.332872 |               50.4648 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     3101 |                2582 |           -0.332872  |               50.4648 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      319 |                 281 |           -0.325964  |               43.7722 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      312 |                 263 |            0.14177   |               48.289  | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      364 |                 323 |            0.0759785 |               48.2972 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     3783 |                3201 |            0.706889  |               48.4224 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
_Diagnostic measurement only — run_date 2026-06-12, spec v1.0. No rule, skill, or schema changes._

Rows analyzed: 1688
Rows matched to council artifacts: 11
Rows with mature T+5: 1466
Rows immature / no-data: 222
...
| WATCH | UNKNOWN | 1503 | 1292 | 0.09% | 46.59% | -0.78% | 5.04% |
...
_Evidence run_date: 2026-06-09_  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 12.0115 | 11.1537 | 51 | 4 | RULE_REVIEW_READY |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 6.8472 | 7.2192 | 65 | 4 | RULE_REVIEW_READY |

### Candidate Hypotheses

| candidate_rule_id | rule_module | setup_family | spread_t5 | trimmed_spread_t5 | n_smaller_bucket | independent_windows_observed | recommended_action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_ACTIVE_BURST_MB_EXIT | MB_EXIT | ACTIVE_BURST | 12.0832 | 11.3015 | 36 | 4 | ADD_TO_DIGEST |
