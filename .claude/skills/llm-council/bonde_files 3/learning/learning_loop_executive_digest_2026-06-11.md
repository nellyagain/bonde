...
_Run timestamp: 2026-06-11 07:19 UTC_
...
4. **Track KK confirmation.** H_KK_CONFIRMATION is alive, low sample (n=94), measurement-only; do not hard-gate Bonde rows from KK yet. (§9)
...
## 2. Changed since last run — 2026-06-11 06:19 UTC → 2026-06-11 07:19 UTC
...
- Tiny-geometry hygiene flagged rows: **30**.
...
- KK confirmation: alive, sample n=94, measurement-only.
...
1. Sugar Baby=True candidates show 0.84% avg T+5 versus -0.65% for non-Sugar Baby candidates (evaluated n=4031 vs 2594). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
| PAUSE          | WATCH_ONLY      | C              | WATCH                |       46 |               41 | ACTIONABLE_SAMPLE |            58.0645 |          1.60926  |
...
| ANTICIPATION   | WATCH_ONLY      | C              | WATCH                |        8 |                7 | LOW_SAMPLE        |            50      |         -0.348133 |
...
|:---------------|:---------------|:----------------|:----------------|:---------------|:--------------|:---------------|:---------------|:--------------|:-----------------------------|:----------------------|:-------------|:--------------------------------------------------|
| ~~PAUSE~~      | ~~B~~          | ~~102~~         | ~~0.9695~~      | ~~54.76~~      | ~~C~~         | ~~41~~         | ~~1.609~~      | ~~58.06~~     | ~~+0.64~~                    | ~~H_PAUSE_BC_INVERT~~ | ~~-2.89~~    | ~~CLOSED (diagnostic: REJECTED / NOT_CONFIRMED)~~ |
...
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Risk-On          |            41 |        1.60926  |           102 |        0.969453 |              0.639805 | 2026-05-16       |        15 |        66 |          -2.89023 | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Risk-On          |             1 |        0.368891 |            93 |        0.208847 |              0.160044 | 2026-05-17       |         0 |        54 |         nan       | WATCHING_LOW_SAMPLE        |
...
### KK summary (v4.14.06)
- KK confirmation: alive, low sample (n=94), measurement-only.
...
|:------------------|:--------------------|:---------------------|-----------------:|-------------------:|----------------------------:|-----------------------------------------:|--------------------------:|------------------------------------:|-------------------------:|---------------------------------:|-----------------------------------:|
| H_KK_CONFIRMATION | WATCHING_LOW_SAMPLE | True                 |                1 |                 93 |                    0.160044 |                                      0.5 |                       nan |                                  80 |                      nan |                              nan |                                  0 |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      123 |               93 |         0.401277 |              0.208847 |                59 |          1.14124  |                20 |          0.330321 |
...
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |       79 |               54 |          0.63754 |               1.09583 |                22 |           1.23838 |                 0 |               nan |
| BONDE_ANTICIPATION_WITH_KK_CONFIRMATION    |        2 |                0 |        nan       |             nan       |                 0 |         nan       |                 0 |               nan |

**KK classification audit sample:**
_Row table suppressed until n>=10/slice; current confirmed n=2, distinct flag patterns=33._
...
- Rows: **2,336**; full-plan proxy rows: **1,074**; rows with ≥5 future bars: **1,734**; OK-evaluable rows: **675**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **586**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=2,152** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=6 (excluded).
...
- Current read: Sugar Baby=True candidates show 0.84% avg T+5 versus -0.65% for non-Sugar Baby candidates (evaluated n=4031 vs 2594).
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     5052 |                4031 |             0.838778 |               47.9037 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     4419 |                3602 |             0.948192 |               48.3065 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     3253 |                2594 |            -0.646882 |               47.687  | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     2821 |                2287 |            -0.517679 |               47.8356 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     2821 |                2287 |            -0.517679 |               47.8356 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      311 |                 278 |            -0.245518 |               43.8849 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      269 |                 226 |             0.312613 |               48.6726 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      397 |                 328 |            -0.240511 |               46.0366 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     3442 |                2770 |             1.26061  |               48.9892 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
| WATCH | UNKNOWN | 1503 | 1169 | -0.10% | 43.34% | -0.50% | 5.29% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 6.3661 | 6.7122 | 63 | 4 | RULE_REVIEW_READY |

### Candidate Hypotheses

| candidate_rule_id | rule_module | setup_family | spread_t5 | trimmed_spread_t5 | n_smaller_bucket | independent_windows_observed | recommended_action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 11.8793 | 10.9270 | 47 | 4 | ADD_TO_DIGEST |
| H_ACTIVE_BURST_MB_EXIT | MB_EXIT | ACTIVE_BURST | 12.1948 | 11.3347 | 32 | 4 | ADD_TO_DIGEST |
