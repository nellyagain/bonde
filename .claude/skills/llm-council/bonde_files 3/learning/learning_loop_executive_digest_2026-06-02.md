...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **219**; rows ≥5 future bars: **953**; unique full-plan+price ticker-date rows: **221**. (§13)
...
4. **Track KK confirmation.** H_KK_CONFIRMATION is alive, low sample (n=65), measurement-only; do not hard-gate Bonde rows from KK yet. (§9)
...
- Tiny-geometry hygiene flagged rows: **9**.
- Dedup diagnostics: **289** raw full-plan+price rows → **221** unique ticker-date rows.
- SLINGSHOT current state: **OK_EVALUABLE rows = 219** (non-zero; H_SLINGSHOT_TARGET_BASIS measurement live). Rows ≥5 future bars: 953.

### Current trading-state
- Post-V5.9.19 TRADE rows: **9**; A1: **0**; A2: **14**. TRADE path is alive.
- KK confirmation: alive, sample n=65, measurement-only.
...
- Master decision-log rows: **1,354**
- Decision-log source files: **16**
- Latest decision-log sources: `daily_decision_log_2026-05-27.csv`, `daily_decision_log_2026-05-28.csv`, `daily_decision_log_2026-05-29.csv`, `daily_decision_log_2026-06-02.csv`, `sample_daily_decision_log.csv`
...
1. Sugar Baby=True candidates show 2.49% avg T+5 versus 0.03% for non-Sugar Baby candidates (evaluated n=2934 vs 1840). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| SLINGSHOT      |      387 |              143 | ACTIONABLE_SAMPLE |         91.4729 |            53.9568 |         0.12806   |
| ACTIVE_BURST   |      178 |              113 | ACTIONABLE_SAMPLE |         92.6966 |            40.1869 |        -0.473439  |
| PAUSE          |      143 |               84 | ACTIONABLE_SAMPLE |         78.3217 |            51.9481 |         1.22239   |
| EP_ACTIVE      |       76 |               51 | ACTIONABLE_SAMPLE |         84.2105 |            54.3478 |         2.66829   |
| DELAYED_EP     |       55 |               33 | ACTIONABLE_SAMPLE |         90.9091 |            61.2903 |         1.49522   |
| ANTICIPATION   |       18 |               11 | BUILDING_SAMPLE   |         77.7778 |            54.5455 |         0.0916514 |
...
|:---------------|:----------------|:---------------|:---------------------|---------:|-----------------:|:------------------|-------------------:|------------------:|
| EP_ACTIVE      | WATCH_ONLY      | B              | WATCH                |       20 |                9 | LOW_SAMPLE        |            77.7778 |          15.7676  |
| EP_ACTIVE      | REJECT          | D              | REJECT               |       17 |                7 | LOW_SAMPLE        |            71.4286 |           9.10541 |
...
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       31 |               17 | BUILDING_SAMPLE   |            62.5    |           1.86365 |
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       48 |               32 | ACTIONABLE_SAMPLE |            50      |           1.8454  |
| SLINGSHOT      | WATCH_ONLY      | B              | WATCH                |      123 |               78 | ACTIONABLE_SAMPLE |            69.2308 |           1.32345 |
...
| SLINGSHOT      | WATCH_ONLY      | C              | WATCH                |      250 |               55 | ACTIONABLE_SAMPLE |            36.5385 |         -0.994991 |
...
- Corpus audit EP9M context rows in master: **203**.
...
|:---------------|:---------------|----------------:|----------------:|---------------:|:--------------|---------------:|---------------:|--------------:|-----------------------------:|
| PAUSE          | B              |              59 |        0.798585 |        45.4545 | C             |             24 |          2.383 |       66.6667 |                      1.58441 |
...
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Risk-on          |            24 |        2.383    |            59 |        0.798585 |              1.58441  | 2026-05-16       |         6 |        22 |          -4.0219  | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Risk-on          |             1 |        0.368891 |            64 |       -0.891916 |              1.26081  | 2026-05-17       |         0 |        22 |         nan       | WATCHING_LOW_SAMPLE        |
...
### KK summary (v4.14.06)
- KK confirmation: alive, low sample (n=65), measurement-only.
...
|:------------------|:--------------------|:---------------------|-----------------:|-------------------:|----------------------------:|-----------------------------------------:|--------------------------:|------------------------------------:|-------------------------:|---------------------------------:|-----------------------------------:|
| H_KK_CONFIRMATION | WATCHING_LOW_SAMPLE | True                 |                1 |                 64 |                     1.26081 |                                      0.5 |                       nan |                                  80 |                      nan |                              nan |                                  0 |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |       94 |               64 |         0.402097 |             -0.891916 |                40 |          1.01128  |                 0 |               nan |
...
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |       50 |               22 |          1.05672 |              -0.76095 |                 0 |               nan |                 0 |               nan |
...
- Source-capable coverage minimum: **98.7%**
- All-row coverage minimum, legacy rows included: **51.6%**
- Source-capable field statuses:
| field                   |   coverage_pct | status   |
|:------------------------|---------------:|:---------|
| day1_close_pct_in_range |           99.3 | OK       |
| day1_move_pct           |           99.6 | OK       |
| day1_vol_ratio          |           98.7 | OK       |
...
- Rows: **1,538**; full-plan proxy rows: **292**; rows with ≥5 future bars: **953**; OK-evaluable rows: **219**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **343**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=1,317** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=43 (excluded).
- Latest pack health: `2026-06-01` **136/136** rows CAPTURED_AT_TRIGGER (entry capture healthy).
...
- Current read: Sugar Baby=True candidates show 2.49% avg T+5 versus 0.03% for non-Sugar Baby candidates (evaluated n=2934 vs 1840).
...
- Sugar Babies ticker lookup rows: **467**
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     3819 |                2934 |            2.48505   |               52.6926 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     3382 |                2638 |            2.54003   |               52.9947 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     2501 |                1840 |            0.0320831 |               50.4891 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     2163 |                1626 |            0.197436  |               50.9225 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     2163 |                1626 |             0.197436 |               50.9225 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      272 |                 204 |             0.952866 |               50      | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      271 |                 204 |             2.6889   |               52.451  | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      355 |                 261 |             1.23669  |               49.0421 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     2484 |                1969 |             2.86181  |               53.8852 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
| P1         | Keep SLINGSHOT target/R:R enrichment in learning loop | Learning loop backfilled 343 DECISION_LOG row(s) from diagnostic/skill-pack planning fields. Actionability skill remains stable; continue measurement-layer enrichment from universe outputs until the raw decision-log schema is intentionally revised. |
...
Rows analyzed: 143
Data issue rows: 32
Repeat stale rows: 24
Valid 20-bar thrust rows: 41
Valid longer-lookback thrust rows: 21
Weak-thrust-only rows: 12
No-real-thrust rows: 12
Insufficient-price-data rows: 1

Raw flag counts:
- data_issue_flag: 32
- repeat_pause_signal_10d_ge2: 39
- repeat_pause_signal_10d_ge3: 25
- valid_longer_lookback_thrust_flag: 55
- weak_thrust_only_flag: 13
- no_real_thrust_flag: 12

Top repeat tickers:
| ticker | count_10d | first_signal_date | last_signal_date |
|---|---|---|---|
| WSR | 7 | 2026-05-05 | 2026-06-01 |
| SILA | 6 | 2026-05-05 | 2026-06-01 |
...
Rows with mature T+5: 930
Rows immature / no-data: 424

### Council vs Actionability Matrix

| actionability | council | n | n_mature_t5 | avg_t5 | win_rate_t5 | avg_t10 | avg_t20 |
|---|---|---|---|---|---|---|---|
| REJECT | UNKNOWN | 157 | 109 | -0.50% | 44.44% | -4.48% | 6.80% |
| TAKE | UNKNOWN | 10 | 1 | -0.10% | 0.00% | -1.11% | n/a |
| WATCH | APPROVE | 4 | 4 | -1.86% | 50.00% | -15.14% | n/a |
| WATCH | REJECT | 3 | 3 | 2.59% | 66.67% | 2.75% | n/a |
| WATCH | UNKNOWN | 1180 | 813 | 0.32% | 44.86% | -0.04% | 21.97% |
...
| RISK_REWARD_WEAK | 6 | 6 | -0.40% | 50.00% | -6.20% | 50.00% |
...
_Evidence run_date: 2026-06-01_  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 4.1222 | 5.0465 | 43 | 3 | ADD_TO_DIGEST |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 10.6210 | 9.9641 | 35 | 3 | ADD_TO_DIGEST |
