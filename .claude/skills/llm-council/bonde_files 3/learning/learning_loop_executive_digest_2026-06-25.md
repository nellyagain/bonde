...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **1,427**; rows ≥5 future bars: **2,923**; unique full-plan+price ticker-date rows: **855**. (§13)
3. **A1 absence is resolved by the A2-floor audit: V5.9.46 has no distinct mechanical A1 gate. A2 is the mechanical top tier.** A1 is not a mechanical rule problem — monitor A2-floor execution quality and realized outcomes, not A1 reachability. PASS_A2_FLOOR rows: **18**; Post-V5.9.19 TRADE rows: **14**; A1 rows: **0**; A2 rows: **38**. (§6)
4. **Track KK confirmation.** H_KK_CONFIRMATION is alive, low sample (n=149), measurement-only; do not hard-gate Bonde rows from KK yet. (§9)
...
## 2. Changed since last run — 2026-06-24 10:08 UTC → 2026-06-25 10:01 UTC
- Prior digest date: **2026-06-24**
- Current digest date: **2026-06-25**
- Comparison window: **2026-06-24 → 2026-06-25**

### Current pipeline status
- SLINGSHOT decision-log target/R:R backfilled rows: **1,001**.
- Tiny-geometry hygiene flagged rows: **67**.
- Dedup diagnostics: **1,639** raw full-plan+price rows → **855** unique ticker-date rows.
- SLINGSHOT current state: **OK_EVALUABLE rows = 1,427** (non-zero; H_SLINGSHOT_TARGET_BASIS measurement live). Rows ≥5 future bars: 2,923.

### Current trading-state
- Post-V5.9.19 TRADE rows: **14**; A1: **0**; A2: **38**. TRADE path is alive.
- KK confirmation: alive, sample n=149, measurement-only.
...
### Deltas vs prior run
- SLINGSHOT OK_EVALUABLE rows: **1,427** (prior 1,397, Δ +30).
- SLINGSHOT rows ≥5 future bars: **2,923** (prior 2,883, Δ +40).
- Post-V5.9.19 TRADE rows: **14** (prior 14, Δ +0).
- A1 rows: **0** (prior 0, Δ +0).
- A2 rows: **38** (prior 38, Δ +0).
...
- Master decision-log rows: **2,370**
- Decision-log source files: **25**
- Latest decision-log sources: `daily_decision_log_2026-06-16.csv`, `daily_decision_log_2026-06-17.csv`, `daily_decision_log_2026-06-19.csv`, `daily_decision_log_2026-06-23 (1).csv`, `daily_decision_log_2026-06-25.csv`
...
- Candidate decision-log files discovered: **37**
- Included decision-log files: **25**
- Excluded decision-log files: **12** (3 duplicate/lower-score files)
- Raw included rows → normalized rows → master rows: **2,394 → 2,394 → 2,370**
...
1. Sugar Baby=True candidates show 0.32% avg T+5 versus 0.03% for non-Sugar Baby candidates (evaluated n=5930 vs 3737). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
3. A1 has zero post-V5.9.19 rows — RESOLVED by the v4.14.27 A2-floor reachability audit (as of 2026-06-24): A1 has no distinct mechanical gate in V5.9.46; 18 row(s) pass every mechanical gate and are withheld from A1 only by discretionary promotion. A1 emptiness is expected, not a bug.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| SLINGSHOT      |     1004 |              731 | ACTIONABLE_SAMPLE |         82.5697 |            62.2614 |          1.29142  |
| PAUSE          |      320 |              280 | ACTIONABLE_SAMPLE |         86.25   |            64.0816 |          1.09939  |
| ACTIVE_BURST   |      279 |              240 | ACTIONABLE_SAMPLE |         94.9821 |            47.7876 |          1.04461  |
| EP_ACTIVE      |      128 |              114 | ACTIONABLE_SAMPLE |         89.0625 |            45      |         -0.108416 |
| DELAYED_EP     |       96 |               77 | ACTIONABLE_SAMPLE |         86.4583 |            59.4203 |          1.22683  |
| ANTICIPATION   |       25 |               25 | ACTIONABLE_SAMPLE |         88      |            45.4545 |          0.273591 |
| PRE_BURST      |       19 |               17 | BUILDING_SAMPLE   |         10.5263 |           100      |          3.27077  |
| EP_SPIKE       |       17 |               15 | BUILDING_SAMPLE   |         94.1176 |            57.1429 |         10.7893   |
...
|:---------------|:----------------|:---------------|:---------------------|---------:|-----------------:|:------------------|-------------------:|------------------:|
| EP_SPIKE       | WATCH_ONLY      | B              | WATCH                |       10 |                9 | LOW_SAMPLE        |            66.6667 |           7.08154 |
| ACTIVE_BURST   | WATCH_ONLY      | B              | COUNCIL              |       10 |               10 | BUILDING_SAMPLE   |            33.3333 |           3.6796  |
| EP_ACTIVE      | WATCH_ONLY      | B              | WATCH                |       54 |               44 | ACTIONABLE_SAMPLE |            57.5    |           3.42538 |
| DELAYED_EP     | WATCH_ONLY      | C              | WATCH                |       23 |               12 | BUILDING_SAMPLE   |            63.6364 |           3.37542 |
| PRE_BURST      | WATCH_ONLY      | B              | WATCH                |       10 |               10 | BUILDING_SAMPLE   |           100      |           3.27077 |
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       95 |               79 | ACTIONABLE_SAMPLE |            57.8947 |           2.51915 |
| SLINGSHOT      | WATCH_ONLY      | B              | WATCH                |      500 |              326 | ACTIONABLE_SAMPLE |            70.684  |           1.64689 |
| PAUSE          | WATCH_ONLY      | C              | WATCH                |      106 |               81 | ACTIONABLE_SAMPLE |            67.6056 |           1.17822 |
...
| EP_ACTIVE      | WATCH_ONLY      | C              | WATCH                |       27 |               24 | ACTIONABLE_SAMPLE |            52.1739 |         -0.975622 |
| ACTIVE_BURST   | WATCH_ONLY      | C              | WATCH                |       59 |               46 | ACTIONABLE_SAMPLE |            42.8571 |         -0.383675 |
| ANTICIPATION   | WATCH_ONLY      | C              | WATCH                |       11 |               11 | BUILDING_SAMPLE   |            40      |         -0.263395 |
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       64 |               56 | ACTIONABLE_SAMPLE |            55.102  |          0.253187 |
| ACTIVE_BURST   | REJECT          | D              | REJECT               |      110 |              100 | ACTIONABLE_SAMPLE |            42.4242 |          0.26291  |
...
### A2-floor reachability funnel (v4.14.27 audit, as of 2026-06-24)
| gate                          |   rows_entering |   rows_passing |   rows_failed |   rows_not_reconstructable |
|:------------------------------|----------------:|---------------:|--------------:|---------------------------:|
| G00_start_rows                |            2242 |           2242 |             0 |                          0 |
| G01_setup_family_eligible     |            2242 |           1676 |           566 |                          0 |
| G02_actionable_candidate      |            1676 |             62 |          1614 |                          0 |
...
- A1 has zero post-V5.9.19 rows — RESOLVED by the v4.14.27 A2-floor reachability audit (as of 2026-06-24): A1 has no distinct mechanical gate in V5.9.46; 18 row(s) pass every mechanical gate and are withheld from A1 only by discretionary promotion. A1 emptiness is expected, not a bug.
...
- Corpus audit EP9M context rows in master: **254**.
...
|:---------------|:---------------|:----------------|:----------------|:---------------|:--------------|:---------------|:---------------|:--------------|:-----------------------------|:----------------------|:-------------|:--------------------------------------------------|
| ~~PAUSE~~      | ~~B~~          | ~~187~~         | ~~1.102~~       | ~~62.8~~       | ~~C~~         | ~~81~~         | ~~1.178~~      | ~~67.61~~     | ~~+0.08~~                    | ~~H_PAUSE_BC_INVERT~~ | ~~-0.03~~    | ~~CLOSED (diagnostic: REJECTED / NOT_CONFIRMED)~~ |
...
|:----------------------------|:-------------------------------|:-------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|--------------:|----------------:|--------------:|----------------:|----------------------:|:-----------------|----------:|----------:|------------------:|:---------------------------|
| H_ACTIVE_BURST_GATE6_SOFTEN | ACTIVE_BURST                   | ACTIVE_BURST D/REJECT minus ACTIVE_BURST C/WATCH avg T+5                                   | Compare ACTIVE_BURST D/REJECT vs ACTIVE_BURST C/WATCH on mature T+5; verdict uses strict OOS rows only.                                                              | RISK_ON          |           100 |         0.26291 |            46 |       -0.383675 |              0.646585 | 2026-05-16       |        61 |        20 |        -0.311529  | WATCHING_NOT_RULE_EVIDENCE |
| H_EP_ACTIVE_COUNCIL_TIGHTEN | EP_ACTIVE                      | EP_ACTIVE final_trade_status=COUNCIL combined avg T+5                                      | Measure EP_ACTIVE rows routed to COUNCIL on mature T+5; verdict uses strict OOS rows only.                                                                           | RISK_ON          |            18 |        -4.91728 |           nan |      nan        |             -4.91728  | 2026-05-16       |         4 |       nan |         2.51199   | WATCHING_LOW_SAMPLE        |
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | RISK_ON          |            81 |         1.17822 |           187 |        1.10208  |              0.076137 | 2026-05-16       |        45 |       116 |        -0.0333822 | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | RISK_ON          |             3 |         2.29367 |           146 |        0.316123 |              1.97755  | 2026-05-17       |         2 |       104 |         2.42437   | WATCHING_LOW_SAMPLE        |
...
### KK summary (v4.14.06)
- KK confirmation: alive, low sample (n=149), measurement-only.
...
|:------------------|:--------------------|:---------------------|-----------------:|-------------------:|----------------------------:|-----------------------------------------:|--------------------------:|------------------------------------:|-------------------------:|---------------------------------:|-----------------------------------:|
| H_KK_CONFIRMATION | WATCHING_LOW_SAMPLE | True                 |                3 |                146 |                     1.97755 |                                      0.5 |                       nan |                                  80 |                      100 |                          10.6957 |                                  0 |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      165 |              146 |         0.327652 |              0.316123 |               113 |          1.23699  |                61 |          1.27506  |
...
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      121 |              104 |         0.436064 |               0.83169 |                73 |           1.36066 |                25 |           2.03638 |
...
| LOCO     | DELAYED_EP     | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
| SEZL     | DELAYED_EP     | CANCEL            | RESOLVED         | LOSER           | ALIGNED                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
| CLSK     | SLINGSHOT      | CANCEL            | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
| IFS      | SLINGSHOT      | DEFER             | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
| CGCT     | SLINGSHOT      | CANCEL            | PENDING          | PENDING         | PENDING                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=NO_PRICE_DATA; available_future_bars=24; OUTCOME_PENDING_NO_PRICE_DATA |
| LLY      | SLINGSHOT      | DEFER             | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
| KGS      | PAUSE          | DEFER             | RESOLVED         | LOSER           | ALIGNED                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
| EFC      | PAUSE          | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
| KEX      | PAUSE          | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=24                               |
...
- Source-capable coverage minimum: **91.8%**
- All-row coverage minimum, legacy rows included: **65.8%**
- Source-capable field statuses:
| field                   |   coverage_pct | status   |
|:------------------------|---------------:|:---------|
| day1_close_pct_in_range |           92.2 | OK       |
| day1_move_pct           |           91.8 | OK       |
| day1_vol_ratio          |           91.9 | OK       |
...
- Rows: **3,723**; full-plan proxy rows: **2,381**; rows with ≥5 future bars: **2,923**; OK-evaluable rows: **1,427**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **1,001**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=3,538** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=7 (excluded).
- Latest pack health: `2026-06-24` **237/237** rows CAPTURED_AT_TRIGGER (entry capture healthy).
- Top missing/evaluability reasons:
| primary_missing_reason   |   rows |
|:-------------------------|-------:|
| OK_EVALUABLE             |   1427 |
| NO_PRICE_DATA            |   1290 |
| INSUFFICIENT_FUTURE_BARS |    550 |
| MISSING_ENTRY            |    185 |
| MISSING_TARGET           |    136 |
...
- Current read: Sugar Baby=True candidates show 0.32% avg T+5 versus 0.03% for non-Sugar Baby candidates (evaluated n=5930 vs 3737).
...
- Sugar Babies ticker lookup rows: **534**
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     7076 |                5930 |            0.318439  |               48.4486 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     6291 |                5268 |            0.553002  |               48.9939 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     4575 |                3737 |            0.0309811 |               51.6189 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     4026 |                3313 |            0.176547  |               52.2487 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     4026 |                3313 |           0.176547   |               52.2487 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      433 |                 341 |          -0.00767423 |               47.5073 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      359 |                 296 |           0.392751   |               51.0135 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      423 |                 346 |          -0.286957   |               47.3988 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     5076 |                4285 |           0.676515   |               49.1015 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
Rows analyzed: 322
Data issue rows: 74
Repeat stale rows: 53
Valid 20-bar thrust rows: 69
...
Raw flag counts:
- data_issue_flag: 74
- repeat_pause_signal_10d_ge2: 110
- repeat_pause_signal_10d_ge3: 77
- valid_longer_lookback_thrust_flag: 144
...
| SILA | 6 | 2026-05-05 | 2026-06-24 |
| TWO | 6 | 2026-05-15 | 2026-06-16 |
| RAMP | 5 | 2026-05-27 | 2026-06-24 |
| TBRG | 4 | 2026-05-05 | 2026-06-24 |
...
- Join failures (NO_MATCH): 2359
- Rows missing trigger_price: 1235
- Rows missing invalidation_price: 1233

## Rule-Readiness Summary

_Report date: 2026-06-25_  
_Evidence run_date: 2026-06-24_  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 12.9997 | 11.1537 | 55 | 6 | RULE_REVIEW_READY |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 6.9025 | 7.1817 | 69 | 6 | RULE_REVIEW_READY |

### Candidate Hypotheses

| candidate_rule_id | rule_module | setup_family | spread_t5 | trimmed_spread_t5 | n_smaller_bucket | independent_windows_observed | recommended_action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_ACTIVE_BURST_MB_EXIT | MB_EXIT | ACTIVE_BURST | 11.2725 | 10.6039 | 38 | 6 | ADD_TO_DIGEST |
