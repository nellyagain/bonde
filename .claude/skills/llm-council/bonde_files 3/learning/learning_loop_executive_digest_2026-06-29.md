...
_Evidence run_date: 2026-06-26_  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 12.8587 | 11.1817 | 64 | 6 | RULE_REVIEW_READY |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 7.2325 | 8.0081 | 84 | 6 | RULE_REVIEW_READY |

### Candidate Hypotheses

| candidate_rule_id | rule_module | setup_family | spread_t5 | trimmed_spread_t5 | n_smaller_bucket | independent_windows_observed | recommended_action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_ACTIVE_BURST_MB_EXIT | MB_EXIT | ACTIVE_BURST | 12.2518 | 11.2850 | 42 | 6 | ADD_TO_DIGEST |
