# R:R Target Realism Audit — 2026-05-20
...
- Rows audited: **37**
- Pending insufficient data: **14** (37.8%)

## 3. Summary

- Rows in audit universe (final_trade_status TRADE/COUNCIL): **37**
- TRADE rows: 1
- COUNCIL rows: **36**
- A1 rows: 1
- A2 rows: **16**
- B+ rows (C1/C2/C3): **12**
- Rows eligible for triggered-only views: **14**

- Rows with V5.9 target parsed: **30**
- Rows with no V5.9 target tag (pre-V5.8.9 or other): 7
- Rows with invalid target parse (geometry guard): 0
- Rows with V5.9 R:R parsed: 29
- Rows with R:R not logged (target may be present): 8

- R:R arithmetic valid (computed within 0.10 of logged): 28
...
|:---------------|:---------------|---------:|-----------------:|--------------------------:|-------------------:|----------------------:|---------------:|---------------:|---------------:|------------------:|---------------------:|-------------------------------:|---------------------------:|----------------:|----------------:|--------------------:|------------------------------:|-----------------------:|---------------------------:|
| A2             | ALL            |       16 |                9 |                      2.51 |               2.33 |                   2.7 |            0.9 |            0.9 |            1.2 |              0.42 |                 -0.3 |                            100 |                        100 |              25 |              25 |                   0 |                             0 |                     75 |                          0 |
| A2             | TRIGGERED_ONLY |       11 |                4 |                      2.7  |               2.44 |                   2.7 |            0.9 |            0.9 |            1.2 |              0.42 |                 -0.3 |                            100 |                        100 |              25 |              25 |                   0 |                             0 |                     75 |                          0 |
...
|:-------------------|:-------------------|:--------------|---------:|-----------------:|--------------------------:|-------------------:|----------------------:|---------------:|---------------:|---------------:|------------------:|---------------------:|-------------------------------:|---------------------------:|----------------:|----------------:|--------------------:|------------------------------:|-----------------------:|---------------------------:|
| BPLUS_BLOCKER_TYPE | bplus_blocker_type | C1            |       10 |                5 |                      1.47 |               1.47 |                  1.45 |           0.15 |           0.15 |           0.99 |              0.13 |                -0.84 |                            nan |                        nan |               0 |               0 |                   0 |                             0 |                    100 |                          0 |
| BPLUS_BLOCKER_TYPE | bplus_blocker_type | C3            |        2 |                1 |                      2.25 |               2.25 |                  2.25 |           0.36 |           0.36 |           1.4  |              0.36 |                -1.04 |                            nan |                        nan |               0 |               0 |                   0 |                             0 |                    100 |                          0 |

## 5. Setup-family Audit

| view         | group_col    | group_value    |   n_rows |   n_with_5d_data |   avg_computed_planned_rr |   avg_effective_rr |   avg_actual_entry_rr |   avg_max_r_5d |   avg_mfe_5d_r |   avg_mae_5d_r |   median_max_r_5d |   expectancy_proxy_r |   pct_rr_overstated_resistance |   pct_rr_overstated_200sma |   pct_hit_1r_5d |   pct_hit_2r_5d |   pct_hit_target_5d |   pct_hit_effective_target_5d |   pct_failed_before_1r |   pct_major_rr_degradation |
|:-------------|:-------------|:---------------|---------:|-----------------:|--------------------------:|-------------------:|----------------------:|---------------:|---------------:|---------------:|------------------:|---------------------:|-------------------------------:|---------------------------:|----------------:|----------------:|--------------------:|------------------------------:|-----------------------:|---------------------------:|
| SETUP_FAMILY | setup_family | ACTIVE_BURST   |       13 |                9 |                      2.09 |               2.09 |                  2.23 |           0.95 |           0.95 |           1.02 |              0.42 |                -0.07 |                            nan |                        nan |           33.33 |           16.67 |                   0 |                             0 |                  66.67 |                          0 |
| SETUP_FAMILY | setup_family | DELAYED_EP     |        7 |                1 |                      2.25 |               2.25 |                  2.27 |         nan    |         nan    |         nan    |            nan    |               nan    |                            nan |                        nan |          nan    |          nan    |                 nan |                           nan |                 nan    |                          0 |
...
| SETUP_FAMILY | setup_family | SLINGSHOT      |        3 |                0 |                      2.17 |               2.17 |                  2.17 |         nan    |         nan    |         nan    |            nan    |               nan    |                            nan |                        nan |          nan    |          nan    |                 nan |                           nan |                 nan    |                          0 |
...
| view                    | group_col               | group_value   |   n_rows |   n_with_5d_data |   avg_computed_planned_rr |   avg_effective_rr |   avg_actual_entry_rr |   avg_max_r_5d |   avg_mfe_5d_r |   avg_mae_5d_r |   median_max_r_5d |   expectancy_proxy_r |   pct_rr_overstated_resistance |   pct_rr_overstated_200sma |   pct_hit_1r_5d |   pct_hit_2r_5d |   pct_hit_target_5d |   pct_hit_effective_target_5d |   pct_failed_before_1r |   pct_major_rr_degradation |
|:------------------------|:------------------------|:--------------|---------:|-----------------:|--------------------------:|-------------------:|----------------------:|---------------:|---------------:|---------------:|------------------:|---------------------:|-------------------------------:|---------------------------:|----------------:|----------------:|--------------------:|------------------------------:|-----------------------:|---------------------------:|
| NEAREST_RESISTANCE_TYPE | nearest_resistance_type | NONE          |       34 |               20 |                      2    |               2    |                  2.14 |           0.63 |           0.63 |           1.22 |              0.36 |                -0.6  |                         nan    |                     nan    |           16.67 |            8.33 |                   0 |                             0 |                  83.33 |                          0 |
