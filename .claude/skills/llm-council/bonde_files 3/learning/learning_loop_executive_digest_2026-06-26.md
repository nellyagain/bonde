...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **1,427**; rows ≥5 future bars: **2,951**; unique full-plan+price ticker-date rows: **941**. (§13)
...
4. **Track KK confirmation.** H_KK_CONFIRMATION is alive, low sample (n=154), measurement-only; do not hard-gate Bonde rows from KK yet. (§9)
...
## 2. Changed since last run — 2026-06-25 10:01 UTC → 2026-06-26 07:48 UTC
- Prior digest date: **2026-06-25**
- Current digest date: **2026-06-26**
- Comparison window: **2026-06-25 → 2026-06-26**

### Current pipeline status
- SLINGSHOT decision-log target/R:R backfilled rows: **1,089**.
- Tiny-geometry hygiene flagged rows: **70**.
- Dedup diagnostics: **1,815** raw full-plan+price rows → **941** unique ticker-date rows.
- SLINGSHOT current state: **OK_EVALUABLE rows = 1,427** (non-zero; H_SLINGSHOT_TARGET_BASIS measurement live). Rows ≥5 future bars: 2,951.

### Current trading-state
- Post-V5.9.19 TRADE rows: **14**; A1: **0**; A2: **38**. TRADE path is alive.
- KK confirmation: alive, sample n=154, measurement-only.
...
### Deltas vs prior run
- SLINGSHOT OK_EVALUABLE rows: **1,427** (prior 1,427, Δ +0).
- SLINGSHOT rows ≥5 future bars: **2,951** (prior 2,923, Δ +28).
...
- Master decision-log rows: **2,476**
- Decision-log source files: **26**
- Latest decision-log sources: `daily_decision_log_2026-06-17.csv`, `daily_decision_log_2026-06-19.csv`, `daily_decision_log_2026-06-23 (1).csv`, `daily_decision_log_2026-06-25.csv`, `daily_decision_log_2026-06-26.csv`
...
- Candidate decision-log files discovered: **38**
- Included decision-log files: **26**
- Excluded decision-log files: **12** (3 duplicate/lower-score files)
- Raw included rows → normalized rows → master rows: **2,500 → 2,500 → 2,476**
...
1. Sugar Baby=True candidates show 0.24% avg T+5 versus 0.15% for non-Sugar Baby candidates (evaluated n=6117 vs 3819). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
3. A1 has zero post-V5.9.19 rows — RESOLVED by the v4.14.27 A2-floor reachability audit (as of 2026-06-25): A1 has no distinct mechanical gate in V5.9.46; 18 row(s) pass every mechanical gate and are withheld from A1 only by discretionary promotion. A1 emptiness is expected, not a bug.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| SLINGSHOT      |     1092 |              731 | ACTIONABLE_SAMPLE |         84.6154 |            62.4082 |          1.58468  |
| PAUSE          |      322 |              280 | ACTIONABLE_SAMPLE |         86.646  |            64.0816 |          1.09939  |
| ACTIVE_BURST   |      292 |              240 | ACTIONABLE_SAMPLE |         95.2055 |            47.7876 |          1.04461  |
| EP_ACTIVE      |      128 |              114 | ACTIONABLE_SAMPLE |         89.0625 |            45      |         -0.108416 |
| DELAYED_EP     |       98 |               77 | ACTIONABLE_SAMPLE |         91.8367 |            59.4203 |          1.22683  |
| ANTICIPATION   |       26 |               25 | ACTIONABLE_SAMPLE |         88.4615 |            45.4545 |          0.273591 |
...
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |      108 |               79 | ACTIONABLE_SAMPLE |            57.8947 |           2.51915 |
| SLINGSHOT      | WATCH_ONLY      | B              | WATCH                |      514 |              326 | ACTIONABLE_SAMPLE |            70.684  |           1.64689 |
| SLINGSHOT      | WATCH_ONLY      | C              | WATCH                |      548 |              393 | ACTIONABLE_SAMPLE |            56.1983 |           1.611   |
...
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       66 |               56 | ACTIONABLE_SAMPLE |            55.102  |          0.253187 |
...
### A2-floor reachability funnel (v4.14.27 audit, as of 2026-06-25)
| gate                          |   rows_entering |   rows_passing |   rows_failed |   rows_not_reconstructable |
|:------------------------------|----------------:|---------------:|--------------:|---------------------------:|
| G00_start_rows                |            2370 |           2370 |             0 |                          0 |
| G01_setup_family_eligible     |            2370 |           1804 |           566 |                          0 |
| G02_actionable_candidate      |            1804 |             62 |          1742 |                          0 |
...
- A1 has zero post-V5.9.19 rows — RESOLVED by the v4.14.27 A2-floor reachability audit (as of 2026-06-25): A1 has no distinct mechanical gate in V5.9.46; 18 row(s) pass every mechanical gate and are withheld from A1 only by discretionary promotion. A1 emptiness is expected, not a bug.
...
- Corpus audit EP9M context rows in master: **260**.
...
|:----------------------------|:-------------------------------|:-------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|--------------:|----------------:|--------------:|----------------:|----------------------:|:-----------------|----------:|----------:|------------------:|:---------------------------|
| H_ACTIVE_BURST_GATE6_SOFTEN | ACTIVE_BURST                   | ACTIVE_BURST D/REJECT minus ACTIVE_BURST C/WATCH avg T+5                                   | Compare ACTIVE_BURST D/REJECT vs ACTIVE_BURST C/WATCH on mature T+5; verdict uses strict OOS rows only.                                                              | Risk-on          |           100 |         0.26291 |            46 |       -0.383675 |              0.646585 | 2026-05-16       |        61 |        20 |        -0.311529  | WATCHING_NOT_RULE_EVIDENCE |
...
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Risk-on          |            81 |         1.17822 |           187 |        1.10208  |              0.076137 | 2026-05-16       |        45 |       116 |        -0.0333822 | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Risk-on          |             3 |         2.29367 |           151 |        0.350348 |              1.94332  | 2026-05-17       |         2 |       109 |         2.40061   | WATCHING_LOW_SAMPLE        |
...
### KK summary (v4.14.06)
- KK confirmation: alive, low sample (n=154), measurement-only.
...
|:------------------|:--------------------|:---------------------|-----------------:|-------------------:|----------------------------:|-----------------------------------------:|--------------------------:|------------------------------------:|-------------------------:|---------------------------------:|-----------------------------------:|
| H_KK_CONFIRMATION | WATCHING_LOW_SAMPLE | True                 |                3 |                151 |                     1.94332 |                                      0.5 |                       nan |                                  80 |                      100 |                          10.8168 |                                  0 |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      166 |              151 |         0.331732 |              0.350348 |               118 |          1.19554  |                68 |          1.20923  |
...
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      122 |              109 |         0.436743 |              0.855452 |                78 |           1.29003 |                32 |           1.72995 |
...
| LOCO     | DELAYED_EP     | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
| SEZL     | DELAYED_EP     | CANCEL            | RESOLVED         | LOSER           | ALIGNED                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
| CLSK     | SLINGSHOT      | CANCEL            | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
| IFS      | SLINGSHOT      | DEFER             | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
| CGCT     | SLINGSHOT      | CANCEL            | PENDING          | PENDING         | PENDING                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=NO_PRICE_DATA; available_future_bars=25; OUTCOME_PENDING_NO_PRICE_DATA |
| LLY      | SLINGSHOT      | DEFER             | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
| KGS      | PAUSE          | DEFER             | RESOLVED         | LOSER           | ALIGNED                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
| EFC      | PAUSE          | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
| KEX      | PAUSE          | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=25                               |
...
- Source-capable coverage minimum: **92.3%**
- All-row coverage minimum, legacy rows included: **67.3%**
- Source-capable field statuses:
| field                   |   coverage_pct | status   |
|:------------------------|---------------:|:---------|
| day1_close_pct_in_range |           92.6 | OK       |
| day1_move_pct           |           92.3 | OK       |
| day1_vol_ratio          |           92.4 | OK       |
...
- Rows: **3,907**; full-plan proxy rows: **2,558**; rows with ≥5 future bars: **2,951**; OK-evaluable rows: **1,427**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **1,089**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=3,722** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=7 (excluded).
- Latest pack health: `2026-06-25` **184/184** rows CAPTURED_AT_TRIGGER (entry capture healthy).
...
- Current read: Sugar Baby=True candidates show 0.24% avg T+5 versus 0.15% for non-Sugar Baby candidates (evaluated n=6117 vs 3819).
...
- Sugar Babies ticker lookup rows: **535**
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     7268 |                6117 |             0.242115 |               48.3243 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     6468 |                5447 |             0.462415 |               48.7975 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     4733 |                3819 |             0.146269 |               52.0031 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     4174 |                3385 |             0.286728 |               52.5849 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     4174 |                3385 |             0.286728 |               52.5849 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      451 |                 355 |             0.293879 |               48.7324 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      364 |                 302 |             0.447633 |               51.9868 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      411 |                 344 |            -0.354573 |               46.5116 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     5242 |                4446 |             0.540089 |               48.7629 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
| P1         | Keep SLINGSHOT target/R:R enrichment in learning loop | Learning loop backfilled 1089 DECISION_LOG row(s) from diagnostic/skill-pack planning fields. Actionability skill remains stable; continue measurement-layer enrichment from universe outputs until the raw decision-log schema is intentionally revised. |
...
- Join failures (NO_MATCH): 2465
- Rows missing trigger_price: 1253
- Rows missing invalidation_price: 1251

## Rule-Readiness Summary

_Report date: 2026-06-26_  
_Evidence run_date: 2026-06-25_  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 12.9179 | 11.0648 | 55 | 6 | RULE_REVIEW_READY |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 6.9477 | 7.2315 | 69 | 6 | RULE_REVIEW_READY |

### Candidate Hypotheses

| candidate_rule_id | rule_module | setup_family | spread_t5 | trimmed_spread_t5 | n_smaller_bucket | independent_windows_observed | recommended_action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_ACTIVE_BURST_MB_EXIT | MB_EXIT | ACTIVE_BURST | 11.1671 | 10.4921 | 38 | 6 | ADD_TO_DIGEST |
