# Skill-Pack Performance Report — 2026-05-23
...
- decision_log_rows_unmatched: **722**
- unmatched_due_to_date_mismatch (ticker is in skill pack, date differs): **0**
- unmatched_due_to_ticker_absent (ticker not in any skill pack): **722**
