...
- unmatched_due_to_date_mismatch (ticker is in skill pack, date differs): **21**
- unmatched_due_to_ticker_absent (ticker not in any skill pack): **6**
