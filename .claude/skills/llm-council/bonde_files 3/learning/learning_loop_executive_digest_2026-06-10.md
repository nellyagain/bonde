...
_Run timestamp: 2026-06-10 13:33 UTC_
...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **675**; rows ≥5 future bars: **1,689**; unique full-plan+price ticker-date rows: **325**. (§13)
...
7. **Rule-readiness item(s) require manual review before any patch.** Ready: H_EP_ACTIVE_FADE_RISK. Candidates: H_MB_EXIT_DAY3_FILTER, H_PAUSE_NO_THRUST_MISFIRE, H_PAUSE_REPEAT_STALE. Soft cautions: H_ACTIVE_BURST_MB_EXIT. (§RR)
   _Rule-readiness source: RULE_READINESS_MONITOR_V14_DF; ID column: candidate_rule_id; monitor rows: 17; non-observe rows: 5._

## 2. Changed since last run — 2026-06-10 12:29 UTC → 2026-06-10 13:33 UTC
...
- SLINGSHOT current state: **OK_EVALUABLE rows = 675** (non-zero; H_SLINGSHOT_TARGET_BASIS measurement live). Rows ≥5 future bars: 1,689.
...
- **1** READY/SUPPORTED item(s) — manual review required: H_EP_ACTIVE_FADE_RISK. Candidates: 3. Soft cautions: 1.
...
1. Sugar Baby=True candidates show 0.80% avg T+5 versus -0.63% for non-Sugar Baby candidates (evaluated n=4055 vs 2629). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| SLINGSHOT      |      456 |              349 | ACTIONABLE_SAMPLE |         90.3509 |            49.0566 |         0.0355819 |
| ACTIVE_BURST   |      184 |              174 | ACTIONABLE_SAMPLE |         92.3913 |            39.375  |        -0.990504  |
| PAUSE          |      167 |              147 | ACTIONABLE_SAMPLE |         80.2395 |            55.4622 |         1.01195   |
| EP_ACTIVE      |       87 |               84 | ACTIONABLE_SAMPLE |         83.908  |            48.5714 |         0.543341  |
| DELAYED_EP     |       55 |               55 | ACTIONABLE_SAMPLE |         85.4545 |            51.0638 |         0.215511  |
...
|:---------------|:----------------|:---------------|:---------------------|---------:|-----------------:|:------------------|-------------------:|------------------:|
| EP_ACTIVE      | WATCH_ONLY      | B              | WATCH                |       33 |               31 | ACTIONABLE_SAMPLE |            59.2593 |          4.30406  |
...
| PAUSE          | WATCH_ONLY      | B              | WATCH                |      117 |              102 | ACTIONABLE_SAMPLE |            54.7619 |          0.969453 |
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       54 |               46 | ACTIONABLE_SAMPLE |            44.186  |          0.842018 |
...
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       39 |               39 | ACTIONABLE_SAMPLE |            43.75   |         -1.26771  |
...
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Mixed            |            42 |         1.56497 |           102 |        0.969453 |               0.59552 | 2026-05-16       |        16 |        66 |          -2.75171 | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Mixed            |             3 |         2.29367 |            99 |        0.132748 |               2.16092 | 2026-05-17       |         2 |        57 |           2.31775 | WATCHING_LOW_SAMPLE        |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      123 |               99 |         0.372932 |              0.132748 |                65 |          1.06464  |                21 |          0.366226 |
...
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |       79 |               57 |         0.604101 |              0.938312 |                25 |              1.15 |                 0 |               nan |
...
- Rows: **2,202**; full-plan proxy rows: **951**; rows with ≥5 future bars: **1,689**; OK-evaluable rows: **675**.
...
- Current read: Sugar Baby=True candidates show 0.80% avg T+5 versus -0.63% for non-Sugar Baby candidates (evaluated n=4055 vs 2629).
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     5052 |                4055 |             0.796313 |               47.7928 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     4419 |                3619 |             0.916594 |               48.2177 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     3253 |                2629 |            -0.633844 |               48.003  | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     2821 |                2309 |            -0.501676 |               48.1161 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     2821 |                2309 |            -0.501676 |               48.1161 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      311 |                 280 |            -0.272456 |               43.5714 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      269 |                 227 |             0.320672 |               48.8987 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      397 |                 331 |            -0.249197 |               45.9215 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     3442 |                2781 |             1.22371  |               48.9033 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
|---|---|---|---|---|---|---|---|
| REJECT | UNKNOWN | 155 | 152 | -1.74% | 41.06% | -5.97% | 6.62% |
| TAKE | UNKNOWN | 9 | 9 | -1.84% | 55.56% | -4.62% | n/a |
| WATCH | APPROVE | 5 | 5 | -1.57% | 40.00% | -5.23% | n/a |
| WATCH | REJECT | 5 | 5 | 1.03% | 60.00% | 6.33% | n/a |
| WATCH | UNKNOWN | 1292 | 1169 | -0.10% | 43.40% | -0.50% | 5.29% |
...
| TAKE_NEUTRAL_OR_UNKNOWN_COUNCIL | 9 | 9 | -1.84% | 55.56% | -4.62% | 44.44% | n/a | n/a |
...
| candidate_rule_id | rule_module | setup_family | spread_t5 | trimmed_spread_t5 | n_smaller_bucket | independent_windows_observed | recommended_action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_PAUSE_REPEAT_STALE | PAUSE | PAUSE_REPEAT_VS_FRESH | 1.0785 | 0.1830 | 47 | 3 | ADD_TO_DIGEST |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 11.7227 | 10.8494 | 43 | 3 | ADD_TO_DIGEST |
| H_PAUSE_NO_THRUST_MISFIRE | PAUSE | PAUSE_NO_THRUST_VS_FOUND | 0.4302 | -0.2245 | 30 | 3 | ADD_TO_DIGEST |
