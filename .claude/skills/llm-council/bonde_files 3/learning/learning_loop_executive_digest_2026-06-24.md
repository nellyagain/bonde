...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **1,397**; rows ≥5 future bars: **2,883**; unique full-plan+price ticker-date rows: **758**. (§13)
3. **A1 absence is resolved by the A2-floor audit: V5.9.46 has no distinct mechanical A1 gate. A2 is the mechanical top tier.** A1 is not a mechanical rule problem — monitor A2-floor execution quality and realized outcomes, not A1 reachability. PASS_A2_FLOOR rows: **15**; Post-V5.9.19 TRADE rows: **14**; A1 rows: **0**; A2 rows: **38**. (§6)
4. **Track KK confirmation.** H_KK_CONFIRMATION is alive, low sample (n=143), measurement-only; do not hard-gate Bonde rows from KK yet. (§9)
...
## 2. Changed since last run — 2026-06-23 05:13 UTC → 2026-06-24 10:08 UTC
- Prior digest date: **2026-06-23**
- Current digest date: **2026-06-24**
- Comparison window: **2026-06-23 → 2026-06-24**

### Current pipeline status
- SLINGSHOT decision-log target/R:R backfilled rows: **895**.
- Tiny-geometry hygiene flagged rows: **58**.
- Dedup diagnostics: **1,431** raw full-plan+price rows → **758** unique ticker-date rows.
- SLINGSHOT current state: **OK_EVALUABLE rows = 1,397** (non-zero; H_SLINGSHOT_TARGET_BASIS measurement live). Rows ≥5 future bars: 2,883.

### Current trading-state
- Post-V5.9.19 TRADE rows: **14**; A1: **0**; A2: **38**. TRADE path is alive.
- KK confirmation: alive, sample n=143, measurement-only.
...
### Deltas vs prior run
- SLINGSHOT OK_EVALUABLE rows: **1,397** (prior 1,342, Δ +55).
- SLINGSHOT rows ≥5 future bars: **2,883** (prior 2,826, Δ +57).
- Post-V5.9.19 TRADE rows: **14** (prior 12, Δ +2).
- A1 rows: **0** (prior 0, Δ +0).
- A2 rows: **38** (prior 35, Δ +3).
- TRADE row(s) added since prior snapshot: MCB|2026-06-23, NBHC|2026-06-23.
...
- Master decision-log rows: **2,242**
- Decision-log source files: **24**
- Latest decision-log sources: `daily_decision_log_2026-06-13.csv`, `daily_decision_log_2026-06-16.csv`, `daily_decision_log_2026-06-17.csv`, `daily_decision_log_2026-06-19.csv`, `daily_decision_log_2026-06-23 (1).csv`
...
- Candidate decision-log files discovered: **36**
- Included decision-log files: **24**
- Excluded decision-log files: **12** (3 duplicate/lower-score files)
- Raw included rows → normalized rows → master rows: **2,266 → 2,266 → 2,242**
...
1. Sugar Baby=True candidates show 0.44% avg T+5 versus -0.04% for non-Sugar Baby candidates (evaluated n=5765 vs 3651). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
3. A1 has zero post-V5.9.19 rows — RESOLVED by the v4.14.27 A2-floor reachability audit (as of 2026-06-23): A1 has no distinct mechanical gate in V5.9.46; 15 row(s) pass every mechanical gate and are withheld from A1 only by discretionary promotion. A1 emptiness is expected, not a bug.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| SLINGSHOT      |      899 |              716 | ACTIONABLE_SAMPLE |         79.4216 |            62.1824 |          1.29906  |
| ACTIVE_BURST   |      270 |              227 | ACTIONABLE_SAMPLE |         94.8148 |            47.4178 |          0.325167 |
| PAUSE          |      316 |              226 | ACTIONABLE_SAMPLE |         84.1772 |            60      |          1.06561  |
| EP_ACTIVE      |      127 |              111 | ACTIONABLE_SAMPLE |         88.9764 |            46.3918 |          0.182161 |
| DELAYED_EP     |       89 |               73 | ACTIONABLE_SAMPLE |         91.0112 |            58.4615 |          1.07713  |
| ANTICIPATION   |       25 |               22 | ACTIONABLE_SAMPLE |         88      |            47.3684 |          0.319008 |
| EP_SPIKE       |       16 |               14 | BUILDING_SAMPLE   |         93.75   |            61.5385 |         11.6272   |
| PRE_BURST      |       18 |               13 | BUILDING_SAMPLE   |         11.1111 |           100      |          3.27077  |
...
|:---------------|:----------------|:---------------|:---------------------|---------:|-----------------:|:------------------|-------------------:|------------------:|
| EP_SPIKE       | WATCH_ONLY      | B              | WATCH                |        9 |                9 | LOW_SAMPLE        |            66.6667 |           7.08154 |
| ACTIVE_BURST   | WATCH_ONLY      | B              | COUNCIL              |       10 |               10 | BUILDING_SAMPLE   |            33.3333 |           3.6796  |
| EP_ACTIVE      | WATCH_ONLY      | B              | WATCH                |       53 |               44 | ACTIONABLE_SAMPLE |            57.5    |           3.42538 |
| PRE_BURST      | WATCH_ONLY      | B              | WATCH                |       10 |               10 | BUILDING_SAMPLE   |           100      |           3.27077 |
| DELAYED_EP     | WATCH_ONLY      | C              | WATCH                |       23 |                8 | LOW_SAMPLE        |            57.1429 |           3.21309 |
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       86 |               79 | ACTIONABLE_SAMPLE |            57.8947 |           2.51915 |
| SLINGSHOT      | WATCH_ONLY      | B              | WATCH                |      395 |              311 | ACTIONABLE_SAMPLE |            71.0884 |           1.68988 |
| PAUSE          | WATCH_ONLY      | C              | WATCH                |      103 |               42 | ACTIONABLE_SAMPLE |            59.375  |           1.56497 |
...
| EP_ACTIVE      | REJECT          | D              | REJECT               |       28 |               27 | ACTIONABLE_SAMPLE |            28      |         -2.65093  |
| ACTIVE_BURST   | REJECT          | D              | REJECT               |      110 |               89 | ACTIONABLE_SAMPLE |            40.9091 |         -1.41669  |
| ACTIVE_BURST   | WATCH_ONLY      | C              | WATCH                |       59 |               44 | ACTIONABLE_SAMPLE |            42.5    |         -0.805968 |
| ANTICIPATION   | WATCH_ONLY      | C              | WATCH                |       11 |                8 | LOW_SAMPLE        |            42.8571 |         -0.370256 |
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       57 |               56 | ACTIONABLE_SAMPLE |            55.102  |          0.253187 |
| EP_ACTIVE      | WATCH_ONLY      | C              | WATCH                |       27 |               21 | ACTIONABLE_SAMPLE |            60      |          0.303598 |
...
| LATEST_SESSION | A2             | TRADE                | SLINGSHOT      |        2 |
| LATEST_SESSION | A2             | WATCH                | SLINGSHOT      |        1 |

### A2-floor reachability funnel (v4.14.27 audit, as of 2026-06-23)
| gate                          |   rows_entering |   rows_passing |   rows_failed |   rows_not_reconstructable |
|:------------------------------|----------------:|---------------:|--------------:|---------------------------:|
| G00_start_rows                |            2076 |           2076 |             0 |                          0 |
| G01_setup_family_eligible     |            2076 |           1510 |           566 |                          0 |
| G02_actionable_candidate      |            1510 |             59 |          1451 |                          0 |
| G03_entry_and_stop_present    |              59 |             56 |             3 |                          0 |
| G04_planned_rr_present        |              56 |             34 |            22 |                          0 |
| G05_rr_floor_ge_2R            |              34 |             34 |             0 |                          0 |
| G06_long_geometry             |              34 |             34 |             0 |                          0 |
| G07_slingshot_clean_structure |              34 |             19 |            15 |                          0 |
| G09_slingshot_vol_gate        |              19 |             19 |             0 |                          0 |
| G10_catalyst_grade_ok         |              19 |             18 |             1 |                          0 |
| G11_dte_gate                  |              18 |             15 |             0 |                          3 |

- First failed gate per row:
| first_failed_gate                  |   n_rows |
|:-----------------------------------|---------:|
| G02_actionable_candidate           |     1451 |
...
- A1 has zero post-V5.9.19 rows — RESOLVED by the v4.14.27 A2-floor reachability audit (as of 2026-06-23): A1 has no distinct mechanical gate in V5.9.46; 15 row(s) pass every mechanical gate and are withheld from A1 only by discretionary promotion. A1 emptiness is expected, not a bug.
...
- Corpus audit EP9M context rows in master: **249**.
...
|:---------------|:---------------|:----------------|:----------------|:---------------|:--------------|:---------------|:---------------|:--------------|:-----------------------------|:----------------------|:-------------|:--------------------------------------------------|
| ~~PAUSE~~      | ~~B~~          | ~~173~~         | ~~0.9924~~      | ~~60.39~~      | ~~C~~         | ~~42~~         | ~~1.565~~      | ~~59.38~~     | ~~+0.57~~                    | ~~H_PAUSE_BC_INVERT~~ | ~~-2.38~~    | ~~CLOSED (diagnostic: REJECTED / NOT_CONFIRMED)~~ |
...
|:----------------------------|:-------------------------------|:-------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|--------------:|----------------:|--------------:|----------------:|----------------------:|:-----------------|----------:|----------:|------------------:|:---------------------------|
| H_ACTIVE_BURST_GATE6_SOFTEN | ACTIVE_BURST                   | ACTIVE_BURST D/REJECT minus ACTIVE_BURST C/WATCH avg T+5                                   | Compare ACTIVE_BURST D/REJECT vs ACTIVE_BURST C/WATCH on mature T+5; verdict uses strict OOS rows only.                                                              | Risk-on          |            89 |        -1.41669 |            44 |       -0.805968 |             -0.610725 | 2026-05-16       |        50 |        18 |          -2.3253  | WATCHING_NOT_RULE_EVIDENCE |
...
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Risk-on          |            42 |         1.56497 |           173 |        0.992367 |              0.572606 | 2026-05-16       |        15 |       102 |          -2.37988 | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Risk-on          |             3 |         2.29367 |           140 |        0.232718 |              2.06095  | 2026-05-17       |         2 |        98 |           2.51196 | WATCHING_LOW_SAMPLE        |
...
### KK summary (v4.14.06)
- KK confirmation: alive, low sample (n=143), measurement-only.
...
|:------------------|:--------------------|:---------------------|-----------------:|-------------------:|----------------------------:|-----------------------------------------:|--------------------------:|------------------------------------:|-------------------------:|---------------------------------:|-----------------------------------:|
| H_KK_CONFIRMATION | WATCHING_LOW_SAMPLE | True                 |                3 |                140 |                     2.06095 |                                      0.5 |                       nan |                                  80 |                      100 |                          11.0901 |                                  0 |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      164 |              140 |         0.342355 |              0.232718 |               110 |          1.26849  |                58 |          1.48754  |
...
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      120 |               98 |         0.463707 |              0.744105 |                70 |           1.41547 |                22 |           2.70037 |
| BONDE_ANTICIPATION_WITH_KK_CONFIRMATION    |        2 |                2 |         0.731373 |              3.25606  |                 2 |           0.40773 |                 0 |         nan       |

**KK classification audit sample:**
_Row table suppressed until n>=10/slice; current confirmed n=2, distinct flag patterns=46._
...
| LOCO     | DELAYED_EP     | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
| SEZL     | DELAYED_EP     | CANCEL            | RESOLVED         | LOSER           | ALIGNED                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
| CLSK     | SLINGSHOT      | CANCEL            | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
| IFS      | SLINGSHOT      | DEFER             | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
| CGCT     | SLINGSHOT      | CANCEL            | PENDING          | PENDING         | PENDING                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=NO_PRICE_DATA; available_future_bars=23; OUTCOME_PENDING_NO_PRICE_DATA |
| LLY      | SLINGSHOT      | DEFER             | RESOLVED         | WINNER          | MISALIGNED                  | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
| KGS      | PAUSE          | DEFER             | RESOLVED         | LOSER           | ALIGNED                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
| EFC      | PAUSE          | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
| KEX      | PAUSE          | DEFER             | RESOLVED         | AMBIGUOUS       | NEUTRAL                     | OUTCOME_JOIN_FALLBACK_DIRECT_PRICE_EVAL: status=EVALUATED_FULL; available_future_bars=23                               |
...
- All-row coverage minimum, legacy rows included: **69.6%**
- Source-capable field statuses:
| field                   |   coverage_pct | status   |
|:------------------------|---------------:|:---------|
| day1_close_pct_in_range |           99.7 | OK       |
| day1_move_pct           |           99.3 | OK       |
...
- Rows: **3,486**; full-plan proxy rows: **2,173**; rows with ≥5 future bars: **2,883**; OK-evaluable rows: **1,397**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **895**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=3,301** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=7 (excluded).
- Latest pack health: `2026-06-23` **274/274** rows CAPTURED_AT_TRIGGER (entry capture healthy).
- Top missing/evaluability reasons:
| primary_missing_reason   |   rows |
|:-------------------------|-------:|
| OK_EVALUABLE             |   1397 |
| NO_PRICE_DATA            |   1290 |
| INSUFFICIENT_FUTURE_BARS |    373 |
| MISSING_ENTRY            |    185 |
| NEVER_TRIGGERED          |    130 |
...
- Current read: Sugar Baby=True candidates show 0.44% avg T+5 versus -0.04% for non-Sugar Baby candidates (evaluated n=5765 vs 3651).
...
- Sugar Babies ticker lookup rows: **531**
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     6867 |                5765 |            0.442756  |               48.9332 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     6097 |                5111 |            0.695129  |               49.5598 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     4400 |                3651 |           -0.0359336 |               51.3284 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     3869 |                3235 |            0.0994009 |               51.8702 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     3869 |                3235 |            0.0994009 |               51.8702 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      415 |                 330 |            0.0194325 |               46.9697 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      365 |                 302 |            0.384205  |               50.6623 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      403 |                 336 |           -0.106455  |               48.2143 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     4914 |                4143 |            0.836623  |               49.7948 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
Rows analyzed: 318
Data issue rows: 73
Repeat stale rows: 51
Valid 20-bar thrust rows: 68
Valid longer-lookback thrust rows: 51
Weak-thrust-only rows: 31
No-real-thrust rows: 43
Insufficient-price-data rows: 1

Raw flag counts:
- data_issue_flag: 73
- repeat_pause_signal_10d_ge2: 107
- repeat_pause_signal_10d_ge3: 74
- valid_longer_lookback_thrust_flag: 141
- weak_thrust_only_flag: 31
- no_real_thrust_flag: 44

Top repeat tickers:
| ticker | count_10d | first_signal_date | last_signal_date |
|---|---|---|---|
| WSR | 7 | 2026-05-05 | 2026-06-09 |
| SILA | 6 | 2026-05-05 | 2026-06-23 |
| TWO | 6 | 2026-05-15 | 2026-06-16 |
| RAMP | 5 | 2026-05-27 | 2026-06-23 |
| AVNS | 4 | 2026-05-05 | 2026-06-23 |
| CPRX | 4 | 2026-05-27 | 2026-06-23 |
| ASRT | 4 | 2026-05-27 | 2026-06-16 |
| TBRG | 3 | 2026-05-05 | 2026-06-23 |
| GBTG | 3 | 2026-05-27 | 2026-06-23 |
| CCRN | 3 | 2026-05-27 | 2026-06-23 |
...
_Diagnostic measurement only — run_date 2026-06-24, spec v1.0. No rule, skill, or schema changes._

Rows analyzed: 2242
Rows matched to council artifacts: 11
Rows with mature T+5: 1901
Rows immature / no-data: 341

### Council vs Actionability Matrix

| actionability | council | n | n_mature_t5 | avg_t5 | win_rate_t5 | avg_t10 | avg_t20 |
|---|---|---|---|---|---|---|---|
| REJECT | UNKNOWN | 210 | 186 | -0.83% | 42.93% | -6.25% | 6.94% |
| TAKE | UNKNOWN | 14 | 12 | -2.33% | 41.67% | -4.62% | n/a |
| WATCH | APPROVE | 6 | 6 | -0.16% | 50.00% | -0.80% | 1.80% |
| WATCH | REJECT | 5 | 5 | 1.03% | 60.00% | 10.92% | 10.16% |
| WATCH | UNKNOWN | 2007 | 1692 | 0.64% | 51.79% | -0.56% | 4.24% |
...
| TAKE_NEUTRAL_OR_UNKNOWN_COUNCIL | 14 | 12 | -2.33% | 41.67% | -4.62% | 44.44% | n/a | n/a |
...
- Join failures (NO_MATCH): 2231
- Rows missing trigger_price: 1217
- Rows missing invalidation_price: 1210

## Rule-Readiness Summary

_Report date: 2026-06-24_  
_Evidence run_date: 2026-06-23_  
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 13.0550 | 11.1761 | 54 | 6 | RULE_REVIEW_READY |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 6.8729 | 7.1491 | 69 | 6 | RULE_REVIEW_READY |

### Candidate Hypotheses

| candidate_rule_id | rule_module | setup_family | spread_t5 | trimmed_spread_t5 | n_smaller_bucket | independent_windows_observed | recommended_action |
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_ACTIVE_BURST_MB_EXIT | MB_EXIT | ACTIVE_BURST | 11.3351 | 10.6721 | 38 | 6 | ADD_TO_DIGEST |
