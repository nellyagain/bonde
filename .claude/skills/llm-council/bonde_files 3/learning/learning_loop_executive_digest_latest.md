...
_Run timestamp: 2026-05-25 09:10 UTC_
...
## 2. Changed since last run — 2026-05-25 07:31 UTC → 2026-05-25 09:10 UTC
- Prior digest date: **2026-05-25**
- Current digest date: **2026-05-25**
- Comparison window: **2026-05-25 → 2026-05-25**

### Pipeline changes
- SLINGSHOT decision-log target/R:R backfilled inside the learning loop: **100** rows.
- Tiny-geometry hygiene audit added / active: **29** rows flagged.
- Dedup diagnostics active: **241** raw full-plan+price rows → **110** unique ticker-date rows.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| ACTIVE_BURST   |      113 |              103 | ACTIONABLE_SAMPLE |         93.8053 |            37.7551 |        -1.0739    |
| SLINGSHOT      |      144 |               63 | ACTIONABLE_SAMPLE |         96.5278 |            35      |        -1.53152   |
| PAUSE          |       89 |               56 | ACTIONABLE_SAMPLE |         88.764  |            50      |         1.163     |
| EP_ACTIVE      |       52 |               36 | ACTIONABLE_SAMPLE |         88.4615 |            48.4848 |        -0.46265   |
| DELAYED_EP     |       33 |               19 | BUILDING_SAMPLE   |         93.9394 |            58.8235 |        -1.09932   |
...
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       32 |               26 | ACTIONABLE_SAMPLE |            50      |          2.67481  |
| ACTIVE_BURST   | ACTIONABLE      | A2             | COUNCIL              |        6 |                6 | LOW_SAMPLE        |            50      |          1.25906  |
| PAUSE          | WATCH_ONLY      | B              | WATCH                |       60 |               37 | ACTIONABLE_SAMPLE |            39.3939 |          0.313392 |
| ACTIVE_BURST   | WATCH_ONLY      | B              | COUNCIL              |        7 |                5 | LOW_SAMPLE        |            25      |          0.210662 |
| ANTICIPATION   | WATCH_ONLY      | C              | WATCH                |        6 |                5 | LOW_SAMPLE        |            60      |         -0.268804 |
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       17 |                9 | LOW_SAMPLE        |            62.5    |         -0.7628   |
...
| SLINGSHOT      | WATCH_ONLY      | C              | WATCH                |       56 |               53 | ACTIONABLE_SAMPLE |            34      |          -1.29779 |
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       17 |                9 | LOW_SAMPLE        |            62.5    |          -0.7628  |
...
- Source-capable coverage minimum: **98.6%**
- All-row coverage minimum, legacy rows included: **29.7%**
- Source-capable field statuses:
| field                   |   coverage_pct | status   |
|:------------------------|---------------:|:---------|
| day1_close_pct_in_range |           99.3 | OK       |
| day1_move_pct           |          100   | OK       |
| day1_vol_ratio          |           98.6 | OK       |
...
- Rows: **953**; full-plan proxy rows: **732**; rows with ≥5 future bars: **270**; OK-evaluable rows: **42**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **100**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=732** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=43 (excluded).
- Latest pack health: `2026-05-22` **72/72** rows CAPTURED_AT_TRIGGER (entry capture healthy).
- Top missing/evaluability reasons:
| primary_missing_reason   |   rows |
|:-------------------------|-------:|
| NO_PRICE_DATA            |    491 |
| MISSING_ENTRY            |    221 |
| INSUFFICIENT_FUTURE_BARS |    193 |
| OK_EVALUABLE             |     42 |
| NEVER_TRIGGERED          |      6 |
...
| P1         | Keep SLINGSHOT target/R:R enrichment in learning loop | Learning loop backfilled 100 DECISION_LOG row(s) from diagnostic/skill-pack planning fields. Actionability skill remains stable; continue measurement-layer enrichment from universe outputs until the raw decision-log schema is intentionally revised. |
...
Raw flag counts:
- data_issue_flag: 15
- repeat_pause_signal_10d_ge2: 26
- repeat_pause_signal_10d_ge3: 16
