...
_Run timestamp: 2026-06-08 13:37 UTC_
...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **5**; rows ≥5 future bars: **83**; unique full-plan+price ticker-date rows: **68**. (§13)
...
## 2. Changed since last run — prior run → 2026-06-08 13:37 UTC
...
- Dedup diagnostics: **135** raw full-plan+price rows → **68** unique ticker-date rows.
...
- Master decision-log rows: **841**
- Decision-log source files: **7**
- Latest decision-log sources: `daily_decision_log_2026-05-09.csv`, `daily_decision_log_2026-05-12.csv`, `daily_decision_log_2026-05-13.csv`, `daily_decision_log_2026-06-05.csv`, `sample_daily_decision_log.csv`
...
- Raw included rows → normalized rows → master rows: **890 → 865 → 841**
...
2. Post-2026-05-15 rows have zero TRADE rows (n=130). Confirm whether this is intended strictness or over-routing to COUNCIL/WATCH.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| ACTIVE_BURST   |      106 |               96 | ACTIONABLE_SAMPLE |         95.283  |            34.0659 |        -1.23472   |
| PAUSE          |       56 |               44 | ACTIONABLE_SAMPLE |         96.4286 |            47.619  |         1.04069   |
| SLINGSHOT      |      146 |               41 | ACTIONABLE_SAMPLE |         86.9863 |            26.8293 |        -2.44218   |
| EP_ACTIVE      |       35 |               33 | ACTIONABLE_SAMPLE |         91.4286 |            46.6667 |        -0.728472  |
...
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       30 |               22 | ACTIONABLE_SAMPLE |            40      |          1.1819   |
| ACTIVE_BURST   | WATCH_ONLY      | B              | COUNCIL              |        5 |                5 | LOW_SAMPLE        |            25      |          0.210662 |
| PAUSE          | WATCH_ONLY      | B              | WATCH                |       35 |               26 | ACTIONABLE_SAMPLE |            33.3333 |         -0.261113 |
...
| ACTIVE_BURST   | REJECT          | D              | REJECT               |       40 |               38 | ACTIONABLE_SAMPLE |            34.2105 |         -2.11297  |
| SLINGSHOT      | WATCH_ONLY      | C              | WATCH                |       34 |               34 | ACTIONABLE_SAMPLE |            29.4118 |         -1.89033  |
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |        8 |                8 | LOW_SAMPLE        |            62.5    |         -0.7628   |
| ANTICIPATION   | WATCH_ONLY      | C              | WATCH                |        5 |                5 | LOW_SAMPLE        |            60      |         -0.268804 |
...
- Corpus audit EP9M context rows in master: **151**.
...
|:----------------------------|:-------------------------------|:-------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------|--------------:|----------------:|--------------:|----------------:|----------------------:|:-----------------|----------:|----------:|------------------:|:---------------------------|
| H_ACTIVE_BURST_GATE6_SOFTEN | ACTIVE_BURST                   | ACTIVE_BURST D/REJECT minus ACTIVE_BURST C/WATCH avg T+5                                   | Compare ACTIVE_BURST D/REJECT vs ACTIVE_BURST C/WATCH on mature T+5; verdict uses strict OOS rows only.                                                              | Mixed            |            38 |        -2.11297 |            24 |       -2.56178  |              0.448813 | 2026-05-16       |         0 |         0 |               nan | WATCHING_NOT_RULE_EVIDENCE |
| H_EP_ACTIVE_COUNCIL_TIGHTEN | EP_ACTIVE                      | EP_ACTIVE final_trade_status=COUNCIL combined avg T+5                                      | Measure EP_ACTIVE rows routed to COUNCIL on mature T+5; verdict uses strict OOS rows only.                                                                           | Mixed            |            11 |        -6.21781 |           nan |      nan        |             -6.21781  | 2026-05-16       |         0 |       nan |               nan | WATCHING_LOW_SAMPLE        |
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Mixed            |            18 |         2.77643 |            26 |       -0.261113 |              3.03754  | 2026-05-16       |         0 |         0 |               nan | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Mixed            |             0 |       nan       |             0 |      nan        |            nan        | 2026-05-17       |         0 |         0 |               nan | WATCHING_NOT_YET_WIRED     |
...
- Raw Council resolver rows loaded: **24.0**
...
- All-row coverage minimum, legacy rows included: **25.4%**
...
- Rows: **293**; full-plan proxy rows: **135**; rows with ≥5 future bars: **83**; OK-evaluable rows: **5**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **0**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=215** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=0 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=78 (excluded).
- Latest pack health: `2026-06-04` **210/210** rows CAPTURED_AT_TRIGGER (entry capture healthy).
...
- Sugar Babies overlay summary not rendered by the early digest pass. v4.14.15 late digest repair will check `RULE_READINESS_SOURCE_DF`, `SUGAR_BABY_TRACKER_DF`, and legacy Sugar files after the bridge cells run.
...
| P1         | Confirm zero-TRADE root cause                | Post-2026-05-15 rows have zero TRADE rows (n=130). Confirm whether this is intended strictness or over-routing to COUNCIL/WATCH.                                             |
...
Data issue rows: 12
Repeat stale rows: 5
Valid 20-bar thrust rows: 18
Valid longer-lookback thrust rows: 11
Weak-thrust-only rows: 5
No-real-thrust rows: 4
Insufficient-price-data rows: 1

Raw flag counts:
- data_issue_flag: 12
- repeat_pause_signal_10d_ge2: 12
- repeat_pause_signal_10d_ge3: 6
- valid_longer_lookback_thrust_flag: 20
- weak_thrust_only_flag: 5
- no_real_thrust_flag: 4

Top repeat tickers:
| ticker | count_10d | first_signal_date | last_signal_date |
|---|---|---|---|
| WSR | 5 | 2026-05-05 | 2026-06-04 |
...
| 1 | RAMP | 2026-06-04 | DATA_ISSUE | Extreme close-to-close move detected: max_abs_c2c_80d=27.3%. Possible corporate action, split-adjustment issue, merger, or bad price data. |
...
|---|---|---|---|---|---|---|---|
| REJECT | UNKNOWN | 100 | 97 | -1.15% | 42.27% | -4.77% | 7.71% |
| TAKE | UNKNOWN | 1 | 1 | -0.10% | 0.00% | -1.11% | n/a |
| WATCH | UNKNOWN | 740 | 617 | -0.12% | 40.33% | -0.68% | 5.05% |
...
- Join failures (NO_MATCH): 841
- Rows missing trigger_price: 639
- Rows missing invalidation_price: 639


**Source-health warning:** Council artifacts were loaded but none joined to decision rows. Treat Council Effectiveness as unavailable for this run and inspect `council_effectiveness_join_audit_latest.csv` plus `council_effectiveness_source_audit_latest.csv`.
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| H_EP_ACTIVE_FADE_RISK | MB_EXIT | EP_ACTIVE_vs_ACTIVE_BURST | 6.3895 | 6.9008 | 32 | 1 | ADD_TO_DIGEST |
| H_MB_EXIT_DAY3_FILTER | MB_EXIT | ALL_APPLICABLE | 12.2154 | 11.6063 | 31 | 1 | ADD_TO_DIGEST |
