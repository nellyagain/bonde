...
2. **Review first SLINGSHOT OK-evaluable cohort under H_SLINGSHOT_TARGET_BASIS; no rule change yet.** OK_EVALUABLE rows: **659**; rows ≥5 future bars: **1,496**; unique full-plan+price ticker-date rows: **400**. (§13)
...
## 2. Changed since last run — 2026-06-05 10:53 UTC → 2026-06-08 16:22 UTC
- Prior digest date: **2026-06-05**
- Current digest date: **2026-06-08**
- Comparison window: **2026-06-05 → 2026-06-08**

### Current pipeline status
- SLINGSHOT decision-log target/R:R backfilled rows: **528**.
- Tiny-geometry hygiene flagged rows: **20**.
- Dedup diagnostics: **671** raw full-plan+price rows → **400** unique ticker-date rows.
- SLINGSHOT current state: **OK_EVALUABLE rows = 659** (non-zero; H_SLINGSHOT_TARGET_BASIS measurement live). Rows ≥5 future bars: 1,496.
...
### Deltas vs prior run
- SLINGSHOT OK_EVALUABLE rows: **659** (prior 556, Δ +103).
- SLINGSHOT rows ≥5 future bars: **1,496** (prior 1,350, Δ +146).
- Post-V5.9.19 TRADE rows: **11** (prior 9, Δ +2).
- A1 rows: **0** (prior 0, Δ +0).
- A2 rows: **17** (prior 16, Δ +1).
...
- Excluded decision-log files: **8** (0 duplicate/lower-score files)
...
1. Sugar Baby=True candidates show 1.44% avg T+5 versus -0.48% for non-Sugar Baby candidates (evaluated n=3785 vs 2431). This is currently the stronger candidate for a future ranking overlay than EP9M, but still needs out-of-sample/weekly validation.
...
5. Corpus reconciliation is now active: 8 decision-log file(s) excluded and 24 row(s) removed by final de-duplication. Check the audit before comparing this digest to prior row counts.
...
|:---------------|---------:|-----------------:|:------------------|----------------:|-------------------:|------------------:|
| SLINGSHOT      |      531 |              342 | ACTIONABLE_SAMPLE |         83.4275 |            49.6795 |         0.132405  |
| ACTIVE_BURST   |      189 |              170 | ACTIONABLE_SAMPLE |         92.5926 |            41.0256 |        -0.898762  |
| PAUSE          |      193 |              140 | ACTIONABLE_SAMPLE |         82.3834 |            54.7826 |         0.978498  |
| EP_ACTIVE      |       93 |               82 | ACTIONABLE_SAMPLE |         84.9462 |            49.2754 |         1.03655   |
| DELAYED_EP     |       57 |               50 | ACTIONABLE_SAMPLE |         84.2105 |            51.1111 |         0.269942  |
| ANTICIPATION   |       20 |               17 | BUILDING_SAMPLE   |         85      |            53.3333 |         0.0872136 |
...
|:---------------|:----------------|:---------------|:---------------------|---------:|-----------------:|:------------------|-------------------:|------------------:|
| EP_ACTIVE      | WATCH_ONLY      | B              | WATCH                |       38 |               29 | ACTIONABLE_SAMPLE |            61.5385 |          5.75761  |
...
| ACTIVE_BURST   | WATCH_ONLY      | B              | WATCH                |       57 |               42 | ACTIONABLE_SAMPLE |            51.2821 |          1.39694  |
| PAUSE          | WATCH_ONLY      | B              | WATCH                |      142 |               95 | ACTIONABLE_SAMPLE |            53.75   |          0.91924  |
| ANTICIPATION   | WATCH_ONLY      | B              | WATCH                |       12 |                9 | LOW_SAMPLE        |            62.5    |          0.487499 |
...
| DELAYED_EP     | WATCH_ONLY      | B              | WATCH                |       41 |               34 | ACTIONABLE_SAMPLE |            43.3333 |         -1.28495  |
...
| EP_ACTIVE      | WATCH_ONLY      | C              | WATCH                |       18 |               18 | BUILDING_SAMPLE   |            58.8235 |         -0.137085 |
...
|:---------------|:---------------|----------------:|----------------:|---------------:|:--------------|---------------:|---------------:|--------------:|-----------------------------:|
| PAUSE          | B              |              95 |         0.91924 |          53.75 | C             |             42 |        1.56497 |        59.375 |                     0.645733 |
...
| H_PAUSE_BC_INVERT           | PAUSE                          | PAUSE C/WATCH minus PAUSE B/WATCH avg T+5                                                  | Compare PAUSE C/WATCH vs PAUSE B/WATCH on mature T+5; verdict uses strict OOS rows only.                                                                             | Risk-On          |            42 |         1.56497 |            95 |       0.91924   |              0.645733 | 2026-05-16       |        16 |        59 |          -2.70578 | WATCHING_NOT_RULE_EVIDENCE |
| H_KK_CONFIRMATION           | ANTICIPATION / KK_CONFIRMATION | Bonde anticipation WITH KK confirmation minus WITHOUT KK confirmation avg T+5 alpha vs SPY | Compare Bonde anticipation rows WITH vs WITHOUT KK research confirmation on T+5 alpha vs SPY; KK definition excludes only kk_pause_too_long from hard disqualifiers. | Risk-On          |             3 |         2.29173 |            92 |      -0.0996505 |              2.39138  | 2026-05-17       |         2 |        50 |           2.62967 | WATCHING_LOW_SAMPLE        |
...
|:------------------|:--------------------|:---------------------|-----------------:|-------------------:|----------------------------:|-----------------------------------------:|--------------------------:|------------------------------------:|-------------------------:|---------------------------------:|-----------------------------------:|
| H_KK_CONFIRMATION | WATCHING_LOW_SAMPLE | True                 |                3 |                 92 |                     2.39138 |                                      0.5 |                       nan |                                  80 |                      100 |                          12.7356 |                                  0 |
...
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |      114 |               92 |         0.433917 |            -0.0996505 |                62 |          1.18078  |                18 |          0.424452 |
| BONDE_ANTICIPATION_WITH_KK_CONFIRMATION    |        3 |                3 |         1.09021  |             2.29173   |                 1 |          0.622096 |                 0 |        nan        |

**Strict OOS cohort split (signal_date >= 2026-05-17; drives verdict):**
| kk_confirmation_cohort                     |   n_rows |   n_evaluable_5d |   avg_ret_5d_all |   avg_alpha_vs_spy_5d |   n_evaluable_10d |   avg_ret_10d_all |   n_evaluable_20d |   avg_ret_20d_all |
|:-------------------------------------------|---------:|-----------------:|-----------------:|----------------------:|------------------:|------------------:|------------------:|------------------:|
| BONDE_ANTICIPATION_WITHOUT_KK_CONFIRMATION |       70 |               50 |         0.748677 |              0.623478 |                22 |           1.48896 |                 0 |               nan |
| BONDE_ANTICIPATION_WITH_KK_CONFIRMATION    |        2 |                2 |         1.01322  |              3.25315  |                 0 |         nan       |                 0 |               nan |
...
- Rows: **2,110**; full-plan proxy rows: **885**; rows with ≥5 future bars: **1,496**; OK-evaluable rows: **659**.
- DECISION_LOG rows target/R:R enriched inside learning loop from universe planning fields: **528**
- Entry-source classification (v4.13.73): **CAPTURED_AT_TRIGGER=1,928** (verdict-eligible pool, gated on T+5 maturity); BACKFILLED_FROM_SIGNAL_CLOSE=178 (robustness panel only, excluded from verdict); MISSING_ENTRY_UNRECOVERABLE=4 (excluded).
- Latest pack health: `2026-06-05` **152/152** rows CAPTURED_AT_TRIGGER (entry capture healthy).
...
- Current read: Sugar Baby=True candidates show 1.44% avg T+5 versus -0.48% for non-Sugar Baby candidates (evaluated n=3785 vs 2431).
...
- Sugar Babies ticker lookup rows: **482**
...
|:------------|:----------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| candidate   | sugar_baby_flag | True          |     4652 |                3785 |             1.43911  |               49.4584 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | True          |     4057 |                3385 |             1.51328  |               49.7784 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| candidate   | sugar_baby_flag | False         |     3033 |                2431 |            -0.484323 |               48.1283 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_flag | False         |     2616 |                2137 |            -0.37027  |               48.1984 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |

### Recurrence buckets
| row_level   | slice_name             | slice_value   |   n_rows |   rows_with_t5_eval |   avg_ret_t5_partial |   win_rate_t5_partial | partial_label                          |
|:------------|:-----------------------|:--------------|---------:|--------------------:|---------------------:|----------------------:|:---------------------------------------|
| ticker      | sugar_baby_runs_bucket | 0             |     2616 |                2137 |           -0.37027   |               48.1984 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 1             |      292 |                 261 |           -0.0376256 |               45.977  | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 2-3           |      254 |                 216 |            0.681446  |               49.0741 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 4-7           |      421 |                 340 |            1.09341   |               48.8235 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
| ticker      | sugar_baby_runs_bucket | 8+            |     3090 |                2568 |            1.79647   |               50.3505 | SUGAR_BABIES_OVERLAY_NOT_RULE_EVIDENCE |
...
_Diagnostic measurement only — run_date 2026-06-08, spec v1.0. No rule, skill, or schema changes._

Rows analyzed: 1585
Rows matched to council artifacts: 10
Rows with mature T+5: 1314
Rows immature / no-data: 271

### Council vs Actionability Matrix

| actionability | council | n | n_mature_t5 | avg_t5 | win_rate_t5 | avg_t10 | avg_t20 |
|---|---|---|---|---|---|---|---|
| REJECT | UNKNOWN | 159 | 152 | -1.74% | 41.06% | -4.86% | 7.65% |
| TAKE | UNKNOWN | 11 | 9 | -1.84% | 55.56% | n/a | n/a |
| WATCH | APPROVE | 5 | 4 | -1.86% | 50.00% | -5.23% | n/a |
| WATCH | REJECT | 5 | 3 | 2.59% | 66.67% | 6.33% | n/a |
| WATCH | UNKNOWN | 1405 | 1146 | -0.02% | 43.66% | -0.05% | 5.53% |
...
| TAKE_NEUTRAL_OR_UNKNOWN_COUNCIL | 11 | 9 | -1.84% | 55.56% | n/a | n/a | n/a | n/a |
...
|---|---|---|---|---|---|---|
| OTHER | 2 | 1 | 2.76% | 100.00% | -3.09% | 0.00% |
| RISK_REWARD_WEAK | 8 | 6 | -0.40% | 50.00% | 0.19% | 66.67% |
